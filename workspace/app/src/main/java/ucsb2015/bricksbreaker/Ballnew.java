...
public class Ballnew {
    ...
    private byte order[] = new byte[30*30*6];
    /*{
            //Faces definition
            0,1,3, 3,2,0,           //Face front
            4,5,7, 7,6,4,           //Face right
            8,9,11, 11,10,8,        //...
            12,13,15, 15,14,12,
            16,17,19, 19,18,16,
            20,21,23, 23,22,20,
    ...
    public Ballnew(Context context) {
        BallCoords = new float[10800];//10800
        ...
        for (int i = 0; i < latitudeBands; i++) {
            for (int j=0; j < longitudeBands; j++) {
                ...
                BallCoords[i*30*4*3 + j*4*3] = (float)Math.sin((i)*M_PI/latitudeBands)*(float)Math.cos((j)*M_PI/longitudeBands);
                BallCoords[i*30*4*3 + j*4*3 + 1] = (float)Math.cos((i)*M_PI/latitudeBands)*(float)Math.cos((j)*M_PI/longitudeBands);
                BallCoords[i*30*4*3 + j*4*3 + 2] = (float)Math.sin((j)*M_PI/longitudeBands);



                BallCoords[i*30*4*3 + j*4*3 + 3] = (float)Math.sin((i+1)*M_PI/latitudeBands)*(float)Math.cos((j)*M_PI/longitudeBands);
                BallCoords[i*30*4*3 + j*4*3 + 4] = (float)Math.cos((i+1)*M_PI/latitudeBands)*(float)Math.cos((j)*M_PI/longitudeBands);
                BallCoords[i*30*4*3 + j*4*3 + 5] = (float)Math.sin((j)*M_PI/longitudeBands);

                BallCoords[i*30*4*3 + j*4*3 + 6] = (float)Math.sin((i)*M_PI/latitudeBands)*(float)Math.cos((j+1)*M_PI/longitudeBands);
                BallCoords[i*30*4*3 + j*4*3 + 7] = (float)Math.cos((i)*M_PI/latitudeBands)*(float)Math.cos((j+1)*M_PI/longitudeBands);
                BallCoords[i*30*4*3 + j*4*3 + 8] = (float)Math.sin((j+1)*M_PI/longitudeBands);

                BallCoords[i*30*4*3 + j*4*3 + 9] = (float)Math.sin((i+1)*M_PI/latitudeBands)*(float)Math.cos((j+1)*M_PI/longitudeBands);
                BallCoords[i*30*4*3 + j*4*3 + 10] = (float)Math.cos((i+1)*M_PI/latitudeBands)*(float)Math.cos((j+1)*M_PI/longitudeBands);
                BallCoords[i*30*4*3 + j*4*3 + 11] = (float)Math.sin((j+1)*M_PI/longitudeBands);
                index = i*30*4*3+j*4*3+11;
                if(index > 10799)
                    Log.d("T", index+" ");


                order[i*30*6 + j*6]   =Byte.valueOf(0+"");
                order[i*30*6 + j*6+1] =Byte.valueOf(1+"");
                order[i*30*6 + j*6+2] =Byte.valueOf(3+"");
                order[i*30*6 + j*6+3] =Byte.valueOf(3+"");
                order[i*30*6 + j*6+4] =Byte.valueOf(2+"");
                order[i*30*6 + j*6+5] =Byte.valueOf(0+"");
